function run_maxminmax_ranksumtest
% RUN_MAXMINMAX_RANKSUMTEST Run rank sum test on the data in mat files
addprojectpath;
matfiles = {'err_maxminmaxtcdebest1', ...
	'err_maxminmaxtcderand1', 'err_maxminmaxtcjade'};

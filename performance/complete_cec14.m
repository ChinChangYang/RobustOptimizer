...
if isfield(solverOptions, 'NP1')
	solverOptions.initial.X1 = ...
		repmat(lb, 1, solverOptions.NP1) + ...
		repmat(ub - lb, 1, solverOptions.NP1) .* ...
		lhsdesign(solverOptions.NP1, D, 'iteration', 100)';
end

if isfield(solverOptions, 'NP2')
	solverOptions.initial.X2 = ...
		repmat(lb, 1, solverOptions.NP2) + ...
		repmat(ub - lb, 1, solverOptions.NP2) .* ...
		lhsdesign(solverOptions.NP2, D, 'iteration', 100)';
end

function [xmin, fmin, out] = derand1eig(fitfun, lb, ub, maxfunevals, options)
% DERAND1EIG DE/rand/1/eig with restart mechanism
% DERAND1EIG(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% DERAND1EIG(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

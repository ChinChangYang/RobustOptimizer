function [xmin, fmin, out] = lshade_sps_eig_l(fitfun, lb, ub, maxfunevals, options)
% SPS_L_SHADE_EIG L-SHADE algorithm with SPS+EIG framework (variant l)

function [xmin, fmin, out] = derand2bin(fitfun, lb, ub, maxfunevals, options)
% DERAND2BIN DE/RAND/2/BIN
% DERAND2BIN(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% DERAND2BIN(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

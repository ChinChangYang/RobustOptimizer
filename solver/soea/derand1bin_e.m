function [xmin, fmin, out] = derand1bin_e(fitfun, lb, ub, maxfunevals, options)
% DERAND1BIN_E DE/RAND/1/BIN for experiments
% DERAND1BIN_E(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% DERAND1BIN_E(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end
...
while true
	...
	for i = 1 : NP		
		...
		while i == r3(i) || r1(i) == r3(i) || r2(i) == r3(i)
			r3(i) = floor(1 + NP * rand);
		end
	end

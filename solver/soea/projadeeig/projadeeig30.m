function [xmin, fmin, out] = projadeeig30(fitfun, lb, ub, maxfunevals, options)
% PROJADEEIG30 Proximity-based JADE/eig with RdExp = 3.0
% PROJADEEIG30(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% PROJADEEIG30(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

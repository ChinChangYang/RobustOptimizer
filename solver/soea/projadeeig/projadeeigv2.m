function [xmin, fmin, out] = projadeeigv2(fitfun, lb, ub, maxfunevals, options)
% PROJADEEIGV2 Proximity-based JADE/eig
% PROJADEEIGV2(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% PROJADEEIGV2(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

defaultOptions.dimensionFactor = 2.3862e+00;
defaultOptions.maxfunevalsFactor = 0;
defaultOptions.R = 3.0316e-02;
defaultOptions.mu_CR = 0.5;
defaultOptions.mu_F = 0.5;
defaultOptions.delta_CR = 5.9552e-02;
defaultOptions.delta_F = 2.3859e-02;
defaultOptions.p = 1.3205e-01;
defaultOptions.w = 2.1265e-02;
defaultOptions.RdExp = 2.8434e+00;
defaultOptions.Display = 'off';
defaultOptions.TolFun = 8.8329e-09;
defaultOptions.FactorNP = 1.8745e+00;
defaultOptions.Restart = 10;
defaultOptions.TolX = 0;
defaultOptions.RecordPoint = 100;
defaultOptions.Noise = false;
defaultOptions.ProInterval = 'NP';
defaultOptions.SampleFactor = 1.25668;

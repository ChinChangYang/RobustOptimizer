function [xmin, fmin, out] = projadeeig20(fitfun, lb, ub, maxfunevals, options)
% PROJADEEIG20 Proximity-based JADE/eig with RdExp = 2.0
% PROJADEEIG20(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% PROJADEEIG20(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

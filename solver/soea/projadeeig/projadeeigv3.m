function [xmin, fmin, out] = projadeeig(fitfun, lb, ub, maxfunevals, options)
% PROJADEEIG Proximity-based JADE/eig
% PROJADEEIG(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% PROJADEEIG(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

defaultOptions.dimensionFactor = 2.162412606983275e+00;
defaultOptions.maxfunevalsFactor = 0;
defaultOptions.R = 5.692461121581361e-01;
defaultOptions.mu_CR = 0.5;
defaultOptions.mu_F = 0.5;
defaultOptions.delta_CR = 1.812371141578162e-01;
defaultOptions.delta_F = 2.059391666143871e-01;
defaultOptions.p = 1.444814209086859e-01;
defaultOptions.w = 1.479536899246934e-01;
defaultOptions.RdExp = 1.622774516845595e+00;
defaultOptions.Display = 'off';
defaultOptions.TolFun = 5.128038304226600e-09;
defaultOptions.FactorNP = 2.164684855447991e+00;

function [xmin, fmin, out] = projadeeig25(fitfun, lb, ub, maxfunevals, options)
% PROJADEEIG25 Proximity-based JADE/eig with RdExp = 2.5
% PROJADEEIG25(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% PROJADEEIG25(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

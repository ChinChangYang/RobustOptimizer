function [xmin, fmin, out] = projadeeig15(fitfun, lb, ub, maxfunevals, options)
% PROJADEEIG15 Proximity-based JADE/eig with RdExp = 1.5
% PROJADEEIG15(fitfun, lb, ub, maxfunevals) minimize the function fitfun in

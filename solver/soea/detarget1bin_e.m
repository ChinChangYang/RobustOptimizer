function [xmin, fmin, out] = detarget1bin_e(fitfun, lb, ub, maxfunevals, options)
% DETARGET1BIN_E DE/TARGET/1/BIN for experiments
% DETARGET1BIN_E(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% DETARGET1BIN_E(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

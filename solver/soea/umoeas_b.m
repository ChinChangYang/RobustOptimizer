function [xmin, fmin, out] = umoeas_b(fitfun, lb, ub, maxfunevals, options)
% UMOEAS_B United Multi-Operator Evolutionary Algorithms (variant B)
% UMOEAS_B(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% UMOEAS_B(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end
...
defaultOptions.MixStageFactor = 0.5;

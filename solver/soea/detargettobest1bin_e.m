function [xmin, fmin, out] = detargettobest1bin_e(fitfun, lb, ub, maxfunevals, options)
% DETARGETTOBEST1BIN_E DE/TARGET-TO-BEST/1/BIN for experiments
% DETARGETTOBEST1BIN_E(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% DETARGETTOBEST1BIN_E(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

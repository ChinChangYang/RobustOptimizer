function [xmin, fmin, out] = dcmaeaeig(fitfun, lb, ub, maxfunevals, options)
% DCMAEAEIG "Eig" variant of Differential covariance matrix adaptation
% evolutionary algorithm
% DCMAEAEIG(fitfun, lb, ub, maxfunevals) minimize the function fitfun in
% box constraints [lb, ub] with the maximal function evaluations
% maxfunevals.
% DCMAEAEIG(..., options) minimize the function by solver options.
if nargin <= 4
	options = [];
end

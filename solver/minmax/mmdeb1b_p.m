function [xbest1, xbest2, fbest, out] = mmdeb1b_p(fitfun, ...
	maxfunevals, lb1, ub1, lb2, ub2, options1, options2)
% MMDEB1B_P Sequential Min-Max DE/best/1/bin with propagation
% MMDEB1B_P(fitfun, maxfunevals1, lb1, ub1, lb2, ub2) minimizes the
...
% MMDEB1B_P(..., options1) minimizes the function with the given
% options Options1 for the 1st layer.
% MMDEB1B_P(..., options1, options2) minimize the function with the

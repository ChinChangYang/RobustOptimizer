function [xbest1, xbest2, fbest, out] = mmder1b_o(fitfun, ...
	maxfunevals, lb1, ub1, lb2, ub2, options1, options2)
% MMDER1B_O Sequential Min-Max DE/rand/1/bin (origin)
% MMDER1B_O(fitfun, maxfunevals1, lb1, ub1, lb2, ub2) minimizes the
...
% MMDER1B_O(..., options1) minimizes the function with the given
% options Options1 for the 1st layer.
% MMDER1B_O(..., options1, options2) minimize the function with the

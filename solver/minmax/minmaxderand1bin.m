function [xminmax1, xminmax2, fminmax, out] = minmaxderand1bin(fitfun1, ...
	maxfunevals1, lb1, ub1, lb2, ub2, options1, options2)
% MINMAXDERAND1BIN Co-evol. DE/rand/1/bin for min-max problems
...
while true
	...
	for i = 1 : NP_Y
		...
		while r1 == r3 || r2 == r3
			r3 = floor(1 + NP_Y * rand);
		end
		
		YV(:, i) = Y(:, r1) + (F + 0.02 * randn) * (Y(:, r2) - Y(:, r3));
	end

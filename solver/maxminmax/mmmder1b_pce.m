...
% MMMDER1B_C Sequential Max-Min-Max DE/rand/1/bin with finding constraint
% boundary 
% [xbest1, xbest2, xbest3] = MMMDER1B_C(fitfun, maxfunevals, lb1,
...
% maxfunevals.
% MMMDER1B_C(..., options1) maximizes the function with the given
% options Options1 for the 1st layer.
% MMMDER1B_C(..., options1, options2) maximizes the function with
% the given options Options2 for the 2nd layer.
% MMMDER1B_C(..., options1, options2, options3) maximizes the
% function with the given options Options3 for the 3rd layer.
% [..., fbest] = MMMDER1B_C(...) returns the function value of the
...
defaultOptions1.InnerSolver = 'mmder1b_pce';
